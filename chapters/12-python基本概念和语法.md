...
reduce(lambda a,b: a+b, [1,2,3])  # 累积：6（需import functools）

# 对象检查
type(123)       # 类型：<class 'int'>
isinstance(123, int)  # 类型判断：True
hasattr(obj, 'name')  # 属性存在性
